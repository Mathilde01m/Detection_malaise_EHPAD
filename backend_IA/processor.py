...
def escalation_monitor():
    """Tâche de fond qui vérifie les alertes non acquittées pour déclencher l'escalade (Critère S4)."""
    # Raccourci pour la démo : secondes au lieu de minutes
...
def on_message(client, userdata, msg):
    try:
        ...
        # 0. Gestion de l'acquittement (Dashboard qui dit "Je prends en charge")
        ...
        if lvl > 0:
            ...
            # Anti-spam : 10 secondes minimum entre deux envois
            if not last_alert or (now - float(last_alert) > 10):
                ...
                # Stockage pour le chronomètre d'escalade
                if lvl in [2, 3, 4]:
